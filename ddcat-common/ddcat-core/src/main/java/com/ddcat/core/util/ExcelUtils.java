...
public class ExcelUtils {
    ...
    public static void exportExcel(List<?> list, String title, String sheetName, String fileName,
                                   HttpServletResponse response, List<ExcelExportEntity> entityList) throws IOException {
        defaultExport(list, fileName, response, new ExportParams(title, sheetName, ExcelType.XSSF), entityList);
    }
    ...
    private static void defaultExport(List<?> list, String fileName, HttpServletResponse response,
                                      ExportParams exportParams, List<ExcelExportEntity> entityList) throws IOException {
